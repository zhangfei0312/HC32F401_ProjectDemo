...
#define CCMR_OC13M_MASK    ((uint32_t)0xFF8F)
#define CCMR_OC24M_MASK    ((uint32_t)0x8FFF) 
...
/**
  ...
  * @param  TIMx: where x can be 1 to 9 to select the TIMx peripheral.
...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  tmpccmrx &= (uint32_t)~(TIM_CCMR1_OC1M_MASK);
...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  tmpccmrx &= (uint32_t)~TIM_CCMR1_OC2M_MASK;
...
/**
  ...
  *         in the TIM_OCInitStruct.
  * @param  TIMx: where x can be 1, 8 or 9 to select the TIM peripheral.
  * @param  TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure that contains
  *         the configuration information for the specified TIM peripheral.
  * @retval None
  */
void TIM_OC3Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Reset the Output Compare mode and Capture/Compare selection Bits */
  tmpccmrx &= (uint32_t)~TIM_CCMR2_OC3M_MASK;
...
void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Reset the Output Compare mode and Capture/Compare selection Bits */
  tmpccmrx &= (uint32_t)~TIM_CCMR2_OC4M_MASK;
...
/**
  ...
  * @param  TIMx: where x can be  1, 2, 8 or 9 to select the TIM peripheral.
  * @param  TIM_OCPreload: new state of the TIMx peripheral Preload register
  *          This parameter can be one of the following values:
  *            @arg TIM_OCPreload_Enable
  *            @arg TIM_OCPreload_Disable
...
/**
  ...
  * @param  TIMx: where x can be 1, 8 or 9 to select the TIM 
  *         peripheral.
