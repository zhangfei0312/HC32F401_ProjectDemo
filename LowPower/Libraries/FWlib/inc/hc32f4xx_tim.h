#ifndef __HC32F4xx_TIM_H
#define __HC32F4xx_TIM_H
...
#define  TIM_CCMR1_OC1M_MASK                  ((uint32_t)0x00010070)  //OCxM & OCxMH
#define  TIM_CCMR1_OC2M_MASK                  ((uint32_t)0x01007000)	//OCxM & OCxMH
#define  TIM_CCMR2_OC3M_MASK                  ((uint32_t)0x00010070)	//OCxM & OCxMH
#define  TIM_CCMR2_OC4M_MASK                  ((uint32_t)0x01007000)	//OCxM & OCxMH
...
typedef struct
{
  ...
  uint8_t  TIM_RepetitionCounter;  /*!< This parameter is valid only for TIM1 and TIM8. */
...
typedef struct
{
  ...
  uint32_t TIM_Pulse;
  uint16_t TIM_OutputNState;  /* This parameter is valid only for TIM1 and TIM8. */
  uint16_t TIM_OCNPolarity;  	/* This parameter is valid only for TIM1 and TIM8. */
  uint16_t TIM_OCNIdleState;  /* This parameter is valid only for TIM1 and TIM8. */
} TIM_OCInitTypeDef;
...
#define TIM_OCMode_CPWM1                   ((uint32_t)0x00010040)
#define TIM_OCMode_CPWM2                   ((uint32_t)0x00010050)
#define TIM_OCMode_APWM1                   ((uint32_t)0x00010060)
#define TIM_OCMode_APWM2                   ((uint32_t)0x00010070)
